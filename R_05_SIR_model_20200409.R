...
# Country <- 'SRB'  # Serbia  SRB is code used for Serbia and Syria !? - input data need to be cleaned
...
# Country <- 'GBR'  # UK - 06.04.: fits data, long epidemy ahead?
...
if (Country == "SVN") {
 ...
 N.int1 <- 13 # starting day of intervention
 NSim <- 100  # No of days for simulation
