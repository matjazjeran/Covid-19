...
# Country <- 'NZL'  # New Zealand - 09.04.: fits data, but unstable results depending on N.int, over the peak
 Country <- 'SVN'  # Slovenia - 09.04.: fits data but unstable results depending on N.int, peak in 2 to 3 days?
...
if (Country == "SRB") {
 StartDate <- "2020-03-09"  # Starting day when first infected was counted > 0
 N.int1 <- 20 # starting day of intervention
 NSim <- 100  # No of days for simulation
...
if (Country == "BEL") {
 ...
 N.int1 <- 9 # starting day of intervention
 NSim <- 100  # No of days for simulation
...
if (Country == "GBR") {
 ...
 N.int1 <- 24 # starting day of intervention - none intervention really so far - so last day
 NSim <- 80  # No of days for simulation
...
if (Country == "SWE") {
 ...
 N.int1 <- 18 # starting day of intervention set manually
 NSim <- 140  # No of days for simulation
...
if (Country == "KOR") {
 ...
 N.int1 <- 26 # starting day of intervention set manually  reasonably good fit for 29,  but awfull for 28 and 30
 NSim <- 100  # No of days for simulation
# Singapore is a difficult case that deserves special treatment as there were two vawes of epidemy
# parameters describing medical care - very dependent on the medical resources - so far the same as in original code
ShareSevereCase    <- 0.2   # share of severe cases - sent to hospital
...
if (Country == "NZL") {
 StartDate <- "2020-03-01"  # Starting day set manually
 N.int1 <- 15 # starting day of intervention
 NSim <- 80  # No of days for simulation
...
title (paste ("Total infections of COVID-19", Country, " - whole simulation model"),
 sub = paste ("StartDate = ", StartDate, "  N.int =", N.int1, "  Last day = ", length(Infected)))
